...
This mechanism has been integrated into Bitcore-Node-Resq which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/resqcoin/insight-api-resq#web-socket-api](https://github.com/resqcoin/insight-api-resq#web-socket-api) 
* API: [https://github.com/resqcoin/insight-api-resq#instantsend-transactions](https://github.com/resqcoin/insight-api-resq#instantsend-transactions) 
...
By default, the Resq Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Resq Core daemon:
