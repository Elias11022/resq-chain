...
Only requiring some minor changes is resq.cpp.
...
Changes to resq.cpp
----------------------
resq.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
