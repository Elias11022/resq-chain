...
{
    if(fLiteMode) return; // disable all Resq specific functionality
...
bool CSporkManager::IsSporkActive(int nSporkID)
{
    ...
    if(mapSporksActive.count(nSporkID)){
        ...
        switch (nSporkID) {
            ...
            case SPORK_15_KILL_BAD_PEER:                    r = SPORK_15_KILL_BAD_PEER_DEFAULT; break;
            default:
...
int64_t CSporkManager::GetSporkValue(int nSporkID)
{
    ...
    switch (nSporkID) {
        ...
        case SPORK_15_KILL_BAD_PEER:                    return SPORK_15_KILL_BAD_PEER_DEFAULT;
        default:
...
int CSporkManager::GetSporkIDByName(std::string strName)
{
    ...
    if (strName == "SPORK_15_KILL_BAD_PEER")			              return SPORK_15_KILL_BAD_PEER;
...
std::string CSporkManager::GetSporkNameByID(int nSporkID)
{
    switch (nSporkID) {
        ...
        case SPORK_15_KILL_BAD_PEER:			              return "SPORK_15_KILL_BAD_PEER";
        default:
