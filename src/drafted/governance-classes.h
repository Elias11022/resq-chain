 ...
 *
 *   // network
 *   CResqNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.resqcoin.info/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CResqNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: ResqNetwork
// //   -- signature requirements : Key1(User)
// class CResqNetworkVariable : public CGovernanceObject
// {
// private:
