...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "ResqNetwork") type = ResqNetwork;
    if(strType == "ResqNetworkVariable") type = ResqNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == ResqNetwork) s = "ResqNetwork";
    if(type == ResqNetworkVariable) s = "ResqNetworkVariable";
