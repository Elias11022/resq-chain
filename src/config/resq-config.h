/* src/config/resq-config.h.  Generated from resq-config.h.in by configure.  */
/* src/config/resq-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef RESQ_CONFIG_H

#define RESQ_CONFIG_H
...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The Resq Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "Resq Core"
...
#define PACKAGE_BUGREPORT "https://github.com/NicholasAdmin/Resq/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Resq Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Resq Core 1.0.2"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "resqcore"
