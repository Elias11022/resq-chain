    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Resq Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Resq address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and resq: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Resq Core"), this);
    aboutAction->setStatusTip(tr("Show information about Resq Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Resq Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Resq addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Resq addresses"));
    ...
    openAction->setStatusTip(tr("Open a resq: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Resq Core help message to get a list with possible Resq Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Resq Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Resq network", "", count));
}
...
{
    QString strTitle = tr("Resq Core"); // default title
