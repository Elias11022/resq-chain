    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Resq Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Resq Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  resq-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Resq in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
PrivateSend uses an resqtive process to mix your inputs with the inputs of two other people, without having your coins ever leave your wallet. \
...
These denominations are 0.01 RESQ, 0.1 RESQ, 1 RESQ and 10 RESQ -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://resqcoin.atlassian.net/wiki/display/DOC/PrivateSend\">https://resqcoin.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Resq Core is shutting down...") + "<br /><br />" +
