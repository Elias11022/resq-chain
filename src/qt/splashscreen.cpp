    ...
    QWidget(0, f), curAlignment(0)
{
    ...
    QString titleText       = tr("Resq Core");
    ...
    QString copyrightTextResq   = QChar(0xA9)+QString(" %1 ").arg(COPYRIGHT_YEAR) + QString(tr("The Resq Core developers"));
    ...
    pixPaint.drawText(paddingLeft,paddingTop+titleCopyrightVSpace+12,copyrightTextResq);
