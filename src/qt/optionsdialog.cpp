    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("RESQ-light"), QVariant("light"));
    ui->theme->addItem(QString("RESQ-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("RESQ-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("RESQ-traditional"), QVariant("trad"));
